    ...
    return (
      <div className='container mx-auto text-center'>
        <div className="text-cetner">
          <h3 className="text-3xl font-bold mb-2">Our All Donation Campining Districs</h3>
          <p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-10'>
            {
                donations.map(donation => <SingleDonation key={donation._id} donation={donation}></SingleDonation>)
            }
        </div>
      </div>
    );
